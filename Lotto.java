...
public class Lotto extends JFrame implements ActionListener{
 ...
 public void start_display(){
  ...
  lotto1 = new JLabel(new ImageIcon("imageLotto/lotto1.jpg"));
  lotto2 = new JLabel(new ImageIcon("imageLotto/lotto2.jpg"));
  lotto3 = new JLabel(new ImageIcon("imageLotto/lotto3.jpg"));
  lotto4 = new JLabel(new ImageIcon("imageLotto/lotto3.jpg"));
  lotto5 = new JLabel(new ImageIcon("imageLotto/lotto2.jpg"));
  lotto6 = new JLabel(new ImageIcon("imageLotto/lotto4.jpg"));
  ...
  if(e.getSource() == ok){
   ...
   for(int i = 0; i < ball.length; i++ ){
    ball[i] = i + 1;
      ...
      lotto1.setIcon(new ImageIcon("imageLotto/"+ball[0]+".jpg"));
      lotto2.setIcon(new ImageIcon("imageLotto/"+ball[1]+".jpg"));
      lotto3.setIcon(new ImageIcon("imageLotto/"+ball[2]+".jpg"));
      lotto4.setIcon(new ImageIcon("imageLotto/"+ball[3]+".jpg"));
      lotto5.setIcon(new ImageIcon("imageLotto/"+ball[4]+".jpg"));
      lotto6.setIcon(new ImageIcon("imageLotto/"+ball[5]+".jpg"));

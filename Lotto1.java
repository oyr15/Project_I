...
public class Lotto1 extends JFrame implements ActionListener{
	...
	public Lotto1(){
		...
		try{
			...
			SwingUtilities.updateComponentTreeUI(Lotto1.this);
		}catch(Exception e){ }
		writeTest();
		start_display();
	}

	public Lotto1(String str)
	{
	...
	public void start_display(){
  	 ...
  	 lotto7_master = new JLabel(new ImageIcon("./imageLotto/lotto4.png"));
		...
		lotto1_master.setBounds(0, 350, 100, 100);
		lotto2_master.setBounds(110, 350, 100, 100);
		lotto3_master.setBounds(210, 350, 100, 100);
		lotto4_master.setBounds(310, 350, 100, 100);
		lotto5_master.setBounds(410, 350, 100, 100);
		lotto6_master.setBounds(510, 350, 100, 100);
		lotto7_master.setBounds(610, 350, 100, 100);
	...
	public void actionPerformed(ActionEvent e){
		...
		int A[] = new int [6], B[] = new int [6], C[] = new int [6],
		 ...
		 if(e.getSource() == ok){
	      ...
	      lotto7_master.setIcon(new ImageIcon("./imageLotto/"+ball_master[6]+".png"));
	   ...
	   lotto7_master.setIcon(new ImageIcon("imageLotto/lotto4.png"));
	  }
